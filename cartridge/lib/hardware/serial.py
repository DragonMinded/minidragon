...
# Fetches the current row position of the cursor on the VT-100.
def serial_pos_row() -> extern[uint8]: ...


# Fetches the current column position of the cursor on the VT-100.
def serial_pos_col() -> extern[uint8]: ...
