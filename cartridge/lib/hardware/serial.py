...
def serial_recv(echo_input: bool = True, mask_input: bool = False, allow_empty: bool = True) -> extern[str]: ...
...
def serial_input(prompt: const[str], echo_input: bool = True, mask_input: bool = False, allow_empty: bool = True) -> extern[str]: ...
