...
U 5F531A2E
F0 "U Lower Clock Edge Detection" 50
F1 "ClockDetect.sch" 50
F2 "ClkIn" I L 1400 1100 50 
F3 "EdgeOut" O R 2500 1100 50 
$EndSheet
$Sheet
S 4700 1000 1000 200 
U 5F531A2F
F0 "U Lower LED Indicator Bit 1" 50
F1 "LEDIndicator.sch" 50
F2 "D" I L 4700 1100 50 
$EndSheet
$Sheet
S 3000 1000 700  550 
U 5F531A30
F0 "U Lower D Flip Flop Bit 1" 50
F1 "DFlipFlop.sch" 50
...
Wire Wire Line
	2700 1200 3000 1200
$Sheet
S 4700 4500 1000 200 
U 5FA68C21
F0 "U Lower Buffer Out Bit 4" 50
F1 "Buffer_4.sch" 50
F2 "BufOut" O R 5700 4600 50 
F3 "D" I L 4700 4600 50 
$EndSheet
$Sheet
S 4700 2500 1000 200 
U 5E73D9C5
F0 "U Lower Buffer Out Bit 2" 50
F1 "Buffer_2.sch" 50
F2 "BufOut" O R 5700 2600 50 
F3 "D" I L 4700 2600 50 
$EndSheet
$Sheet
S 4700 3000 1000 200 
U 5F531917
F0 "U Lower LED Indicator Bit 3" 50
F1 "LEDIndicator_3.sch" 50
F2 "D" I L 4700 3100 50 
$EndSheet
$Sheet
S 4700 2000 1000 200 
U 5F5319E7
F0 "U Lower LED Indicator Bit 2" 50
F1 "LedIndicator_2.sch" 50
F2 "D" I L 4700 2100 50 
$EndSheet
$Sheet
S 4700 1500 1000 200 
U 5F5319E3
F0 "U Lower Buffer Out Bit 1" 50
F1 "Buffer.sch" 50
F2 "BufOut" O R 5700 1600 50 
F3 "D" I L 4700 1600 50 
$EndSheet
Wire Wire Line
	5700 1600 6300 1600
Wire Wire Line
...
S 3000 2000 700  550 
U 5FA68C27
F0 "U Lower D Flip Flop Bit 2" 50
...
S 3000 3000 700  550 
U 5F531A34
F0 "U Lower D Flip Flop Bit 3" 50
...
S 3000 4000 700  600 
U 5E73DA1B
F0 "U Lower D Flip Flop Bit 4" 50
...
Q4
$Sheet
S 4700 3500 1000 200 
U 5F531A58
F0 "U Lower Buffer Out Bit 3" 50
F1 "Buffer_3.sch" 50
F2 "BufOut" O R 5700 3600 50 
F3 "D" I L 4700 3600 50 
$EndSheet
$Sheet
S 4700 4000 1000 200 
U 5FA68CBB
F0 "U Lower LED Indicator Bit 4" 50
F1 "LEDIndicator_4.sch" 50
F2 "D" I L 4700 4100 50 
$EndSheet
$EndSCHEMATC
