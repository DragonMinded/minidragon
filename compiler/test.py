...
from .core import CompilerError, FunctionPrototype, parse_prototypes, parse_and_compile
...
class TestCompiler(unittest.TestCase):
    ...
    def test_allow_global_const_declaration_init(self) -> None:
        ...
        output = parse_and_compile("__test__", 'UINT8_CONST: const(str) = "test"', [])
    ...
    def test_define_simple_function(self) -> None:
        ...
        self.assertEqual([FunctionPrototype("simple", "None", [])], prototypes)
